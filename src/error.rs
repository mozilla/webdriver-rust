...
impl ErrorStatus {
    ...
    pub fn http_status(&self) -> StatusCode {
        match *self {
            ...
            ErrorStatus::NoSuchAlert => StatusCode::NotFound,
            ErrorStatus::NoSuchCookie => StatusCode::NotFound,
            ErrorStatus::NoSuchElement => StatusCode::NotFound,
            ErrorStatus::NoSuchFrame => StatusCode::NotFound,
            ErrorStatus::NoSuchWindow => StatusCode::NotFound,
            ...
            ErrorStatus::UnknownCommand => StatusCode::NotImplemented,
